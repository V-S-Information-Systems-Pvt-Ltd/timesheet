...
import { IconCheck, IconClock, IconCopy, IconDocument, IconPencil, IconTrash } from '@/app/components/icons'
                    ...
                    <Td className="text-right">
                      {canEdit ? (
                        <div className="inline-flex items-center gap-1">
                          ...
                          <Button variant="ghost" size="sm" onClick={() => handleDuplicateEntry(t)} className="px-2 text-slate-500 hover:bg-slate-100" title="Duplicate entry">
