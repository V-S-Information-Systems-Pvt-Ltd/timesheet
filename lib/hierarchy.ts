...
// the permission axis.
//
// The reporting-tree projection (buildHierarchyTree) is canonical in @vsis/core
// and shared with mobile; it is re-exported here so existing callers keep one
// import path. The profile-specific "reports to" helpers below stay here
// because they operate on the web `User` shape.
