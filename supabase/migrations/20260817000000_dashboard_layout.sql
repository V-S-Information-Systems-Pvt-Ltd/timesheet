-- supabase/migrations/20260817000000_dashboard_layout.sql
-- Per-user dashboard tile customization and the default "Internal" project.
-- Same change as db/migrations/0004_dashboard_layout.sql (native backend).
--
-- Idempotent: safe to re-run after a partial/manual application.
-- Existing RLS policies cover the new column (profiles update: own row via
-- profiles_update_own_details; select: own or admin).
