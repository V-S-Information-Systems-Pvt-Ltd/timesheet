...
// Canonical pure date helpers shared by the web server and the mobile client.
// All functions work on local-time ISO dates (YYYY-MM-DD) so behavior is
// consistent between the client and server regardless of timezone. Device-local
// date *presentation* (friendly labels, datetime-local formatting) stays in the
