...
// Canonical pure projection that turns a flat list of profile-like rows into a
// reporting tree. Platform-neutral and structural: it accepts either the web
// snake_case fields (manager_id, hierarchy_role) or the mobile camelCase fields
// (managerId, hierarchyRole), so both applications build the same tree without
